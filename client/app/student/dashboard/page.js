    ...
    <div className="min-h-screen flex bg-gray-100">
      ...
      <div className="flex-1 flex flex-col">
        ...
        {/* Main area: two columns inside the main content:
            - content column (flex-auto)
            - optional right column for avatar/badges (w-80)
        */}
          ...
          <main className="flex-1">
            ...
            <section>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {/* Example course card - repeat/map this */}
                <div className="bg-white p-4 rounded-lg shadow">
                  ...
                  <div className="mt-4">
                    ...
                    <div className="mt-2 text-sm text-gray-600">Progress: 33%</div>
                  </div>
                </div>

                {/* duplicate card demo */}
                <div className="bg-white p-4 rounded-lg shadow">Course Card 2</div>
                <div className="bg-white p-4 rounded-lg shadow">Course Card 3</div>
              </div>
            </section>
          </main>

          {/* Right column: profile / badges (optional) */}
